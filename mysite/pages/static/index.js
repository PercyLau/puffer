function rand_alg() {
  var rand_urls = [
    "../static/player.html?aid=1",
    "../static/player.html?aid=2",
    "../static/player.html?aid=3",
    "../static/player.html?aid=4",
    "../static/player.html?aid=5",
    "../static/player.html?aid=6",
    "../static/player.html?aid=7",
    "../static/player.html?aid=8",
    "../static/player.html?aid=10",
    "../static/player.html?aid=11"
  ];
...
function init_app() {
  ...
  firebase.auth().onAuthStateChanged(function(user) {
    if (user) {
      ...
      window.location.replace('../static/widget.html');
    }
  });
